...
/**
 * Request body used to create a procurement contract.
 *
 * The DTO captures persisted contract fields only; derived expiry state is
 * calculated by the service from status and end date.
 */
