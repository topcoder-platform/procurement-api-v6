...
/**
 * Request body used to create a procurement invoice.
 *
 * The DTO stores only the persisted invoice fields; pending and overdue state
 * is derived by the service from status, due date, and paid date.
 */
